...
wk7 <- wk7 %>% 
  ...
  mutate(Weekly.GRS.Order.Units = Weekly.GRS.Order.Units/Units.per.case)
...
wk7.instocks$Weekly.AM.Order.Units[wk7.instocks$Weekly.AM.Order.Units>29] <- 29
wk7.instocks$Weekly.GRS.Order.Units[wk7.instocks$Weekly.GRS.Order.Units>29] <- 29
